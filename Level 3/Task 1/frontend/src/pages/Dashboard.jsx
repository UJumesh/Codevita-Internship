  ...
  return (
    <div className="App">
      ...
      <div className="dashboard">
        <section className="hero-panel">
          <div className="hero-copy">
            ...
            <div className="hero-actions">
              <span className="hero-stat">Realtime sync</span>
              <span className="hero-stat accent">Modern UI</span>
            </div>
          </div>
        ...
        <div className="cards">
          <DashboardCard icon={<FaCode />} title="Total Skills" value={totalSkills} />
          <DashboardCard icon={<FaBullseye />} title="Total Users" value={totalUsers} />
          <DashboardCard icon={<FaProjectDiagram />} title="Projects" value="3" />
        </div>
        ...
        <section className="section">
          <div className="section-header">
            <div>
              <div className="section-eyebrow">Growth</div>
              <h2>💻 Skill Management</h2>
            </div>
            <span className="section-tag">Progress</span>
          </div>

          <SkillForm onSkillAdded={reloadSkills} />

          <SkillList refresh={refreshSkills} search={search} setTotalSkills={setTotalSkills} />
        </section>
      </div>
    </div>
  );
